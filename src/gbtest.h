...
typedef struct Reg8_Exp       { GbAccess::Reg8       reg; uint8_t  val; } Reg8_Exp;
typedef struct Reg16_Exp      { GbAccess::Reg16      reg; uint16_t val; } Reg16_Exp;
typedef struct Reg16_SP_Exp   { GbAccess::Reg16_SP   reg; uint16_t val; } Reg16_SP_Exp;
//typedef struct Reg16_Addr_Exp { GbAccess::Reg16_Addr reg; uint16_t val; } Reg16_Addr_Exp;
...
typedef struct Flag_Exp { GbAccess::Flag flag; bool val; } Flag_Exp;
...
protected:
    ...
    void expect_flag(const GbAccess::Flag &flag, const bool &val);
    ...
    void expect_reg(const GbAccess::Reg8     &reg, const uint8_t  &val);
    void expect_reg(const GbAccess::Reg16    &reg, const uint16_t &val);
    void expect_reg(const GbAccess::Reg16_SP &reg, const uint16_t &val);
    //void expect_reg(const GbAccess::Reg16_Addr &reg, const uint16_t &val);
